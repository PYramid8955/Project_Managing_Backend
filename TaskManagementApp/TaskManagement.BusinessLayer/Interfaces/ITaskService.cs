...
public interface ITaskService
{
    ...
    Task<IEnumerable<TaskResponse>> GetProjectTasksAsync(Guid projectId, Guid userId, string? status = null, string? difficulty = null, string? sortBy = null, Guid? assignedToFilter = null);
